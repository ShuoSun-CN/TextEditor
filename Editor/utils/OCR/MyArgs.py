class Args:
    def __init__(self):
        ...
        self.image_dir = None  # or set a default path
        self.page_num = 0
        self.det_algorithm = "DB"
        self.det_model_dir = 'your/base/model/path/ch_PP-OCRv3_det_infer'
        self.det_limit_side_len = 960.0
        ...
        # PSE params
        self.det_pse_thresh = 0.0
        self.det_pse_box_thresh = 0.85
        self.det_pse_min_area = 16.0
        ...
        self.rec_model_dir = 'your/base/model/path/ch_PP-OCRv3_rec_infer'
        ...
        self.e2e_model_dir = None  # or set a default path
        self.e2e_limit_side_len = 768.0
        ...
        self.cls_model_dir = 'your/base/model/path/cls'
        ...
        # SR params
        self.sr_model_dir = None  # or set a default path
