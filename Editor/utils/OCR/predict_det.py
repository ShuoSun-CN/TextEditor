...
from Editor.utils.OCR.ppocr.data import create_operators, transform
from Editor.utils.OCR.ppocr.postprocess import build_post_process
import json
...
def OCRforPic(img_name):
    ...
    print(args)
    image_file_list = get_image_file_list(img_name)
    total_time = 0
    ...
    for idx, image_file in enumerate(image_file_list):
        ...
        for index, img in enumerate(imgs):
            ...
            orc_result_name='ORC-'+os.path.basename(save_file)
            img_path=draw_img_save_dir+'/'+orc_result_name
